...
import edu.kosta.chatting.chat_thrusday.client.cli.TalkCli;
import edu.kosta.chatting.chat_thrusday.framework.Dispatcher;
import edu.kosta.chatting.chat_thrusday.framework.io.SocketDispatcher;
import edu.kosta.chatting.chat_thrusday.framework.io.SocketReactor;
import edu.kosta.chatting.chat_thrusday.framework.io.SocketWorker;
...
public class TalkClient {
	...
	public static void main(String[] args) throws UnknownHostException, IOException {
		...
		Talker talker = new Talker("���ö", dispatcher);
